...
<main>
  ...
  <form id="f" autocomplete="off">
    ...
    <div class="modes" role="radiogroup" aria-label="Niveau">
      <label><input type="radio" name="mode" value="debutant" checked><svg viewBox="0 0 80 80" aria-hidden="true"><path d="M27 33a13 13 0 0 1 26 0v12a13 13 0 0 1-26 0Z"/><path d="M29.5 30c2.5-5 6-7.5 10.5-7.5s8 2.5 10.5 7.5"/><path d="M40.5 21.5c-1-3 0-5 2.5-6"/><path d="M27 35c-4 0-4 7 0 7M53 35c4 0 4 7 0 7"/><path d="M33 36h4M43 36h4"/><path d="M40 38.5v4.5"/><path d="M34.5 46q5.5 4 11 0"/></svg><span class="h">Débutant</span><span class="w">Je débute, ou je ne lis pas l'hébreu</span><span class="d">Tout en français, chaque terme expliqué, le contexte avant la réponse.</span></label>
      <label><input type="radio" name="mode" value="classique"><svg viewBox="0 0 80 80" aria-hidden="true"><path d="M27 32a13 13 0 0 1 26 0v20a13 13 0 0 1-26 0Z"/><path d="M31 24c2.5-5.5 15.5-5.5 18 0"/><path d="M27 35c-4 0-4 7 0 7M53 35c4 0 4 7 0 7"/><path d="M33 36h4M43 36h4"/><path d="M40 38.5v4.5"/><path d="M30.5 46.5c3-3.5 6.5-3.5 9.5-1.5c3-2 6.5-2 9.5 1.5c-3 1.2-6.2 1.6-9.5.8c-3.3.8-6.5.4-9.5-.8Z"/></svg><span class="h">Classique</span><span class="w">J'ai les bases</span><span class="d">La source puis sa traduction ; les termes usuels sont supposés connus.</span></label>
      <label><input type="radio" name="mode" value="avance"><svg viewBox="0 0 80 80" aria-hidden="true"><path d="M30 14h20l2 14h-24Z"/><path d="M21 28h38"/><path d="M27 28v32a13 13 0 0 0 26 0V28"/><path d="M26.5 36c-4 1-3 6-1 8c-3 2-3 6-1 9M53.5 36c4 1 3 6 1 8c3 2 3 6 1 9"/><path d="M33 36h4M43 36h4"/><path d="M40 38.5v4.5"/><path d="M30.5 46.5c3-3.5 6.5-3.5 9.5-1.5c3-2 6.5-2 9.5 1.5c-3 1.2-6.2 1.6-9.5.8c-3.3.8-6.5.4-9.5-.8Z"/></svg><span class="h">Avancé</span><span class="w">Beit midrash</span><span class="d">Langue originale, terminologie sans glose, mahloket et lomdus.</span></label>
    </div>
